...
const SearchBar = ({
  ...
  return (
    <div
      className={`flex sm:searchBarDesktop searchBarMobile ${
    ...
    >
      <div className={` shadow py-2 ${isDark ? "bg-[#2b3945]" : "bg-white"}`}>
        ...
        <input
          ...
          className={`cursor-pointer ${isDark ? "bg-[#2b3945]" : "bg-white"} ${
      ...
      <div>
        <select
          ...
          name="currency"
          id="currency"
          className={`sm:filterSubRegion filterMobile ${
        ...
        <select
          ...
          name="region"
          id="region"
          className={`sm:filterDesktop filterMobile mx-8 ${
            isDark ? "bg-[#2b3945]" : "bg-white"
          } ${isDark ? "text-white" : "text-black"}`}
        >
        ...
        <select
          ...
          name="sorting"
          id="sorting"
          className={`sm:sorting filterMobile mx-8 ${
            isDark ? "bg-[#2b3945]" : "bg-white"
          } ${isDark ? "text-white" : "text-black"}`}
        >
          <option value="">Sorting</option>
          <option value="populationAscen">
            Sorting of Population in Ascending Order
          </option>
          <option value="populationDescen">
            Sorting of Population in Descending Order
          </option>
          <option value="areaAscen">Sorting of Area in Ascending Order</option>
          <option value="areaDescen">
            Sorting of Area in Descending Order
          </option>
        </select>
      </div>
    </div>
